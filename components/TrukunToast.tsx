...
const TrukunToast = forwardRef<ToastRef, {}>((props, ref) => {
  ...
  const handleGesture = useCallback(
    (event: {
      ...
      if (isHorizontalSwipe || isVerticalSwipe) {
        const direction = isHorizontalSwipe ? translationX : translationY;
        toastsideAnimation.value = withSpring(direction > 0 ? 500 : -500, {
          velocity: 50,
        });
  ...
  return (
    <PanGestureHandler onGestureEvent={handleGesture}>
      <Animated.View
        style={[styles.toastContainer, containerStyle, animatedTopStyles]}
      >
...
TrukunToast.displayName = "TrukunToast";

export default TrukunToast;
